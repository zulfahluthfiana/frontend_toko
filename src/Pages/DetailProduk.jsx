...
const DetailProduk = () => {
  ...
  const detailItems = [
    {
      label: "Varian Rasa",
      value: product.product.varian_rasa || "Data tidak tersedia",
    },
    { label: "Bentuk", value: product.product.bentuk || "Data tidak tersedia" },
  ];

  return (
    <>
    <NavHeader nav="Produk" page="Beranda" pagenav1=">" page2="Produk"  pagenav2=">" page3="Detail Produk" />
    <div className="flex flex-col items-center mx-20 p-1">
        ...
        <div className="mt-4 w-full text-base font-light font-Satoshi-Light">
          <div className="space-y-4">
            ...
            <p className="mt-4 text-base font-light font-Satoshi-Light">
              {product.product.deskripsi || "Deskripsi tidak tersedia"}
            </p>
            <a
